...
La versión visible actual es `0.17.1`. El coordinador revisará periódicamente si los cambios acumulados justifican un nuevo incremento y preguntará antes de modificarla.
