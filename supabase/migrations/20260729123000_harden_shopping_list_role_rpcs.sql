revoke execute on function public.get_shopping_list_members(uuid) from anon, public;
revoke execute on function public.remove_shopping_list_member(uuid, uuid) from anon, public;
