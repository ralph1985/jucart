...
Cuando exista histórico suficiente, la lista de compra debe priorizar información útil por producto, especialmente último precio y precio medio, sin convertir la bandeja de tickets en la superficie principal de análisis.
